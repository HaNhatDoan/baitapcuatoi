...
$mysql = "SELECT *FROM chitietsanpham WHERE loai_sp like 'Giường' LIMIT $sosanpham OFFSET $offset";
$result = mysqli_query($conn, $mysql);
$total = mysqli_query($conn, "SELECT *FROM chitietsanpham WHERE loai_sp like 'Giường' ");
